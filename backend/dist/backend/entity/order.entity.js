...
exports.OrderSchema = exports.Order = exports.OrderDetailSchema = exports.OrderDetail = void 0;
...
__decorate([
    (0, mongoose_1.Prop)({ type: [exports.OrderDetailSchema], default: [] }),
...
], Order.prototype, "imageBase64", void 0);
__decorate([
    (0, mongoose_1.Prop)({ type: Number, required: true }),
    __metadata("design:type", Number)
